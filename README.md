...
- [ServiceNow IAM Access Request Workflow](https://github.com/IAMLEX1/servicenow-iam-access-request-workflow)

- [Entra ID Privileged Access Lab](https://github.com/IAMLEX1/entra-id-privileged-access-lab)

- [Entra ID AWS SSO Integration](https://github.com/IAMLEX1/entra-id-aws-sso-integration)
...
- Strengthened authentication security using MFA and Conditional Access policies to reduce account compromise risk
...
- [AWS EC2 Threat Detection GuardDuty](https://github.com/IAMLEX1/aws-ec2-threat-detection-guardduty)

- [Secure Remote Access VPN Azure](https://github.com/IAMLEX1/secure-remote-access-vpn-azure)
...
- Built AWS Organizations and applied Service Control Policies (SCPs) to restrict unauthorized actions across accounts

- Set up AWS Identity Center (SSO) to centralize and simplify multi-account access management
